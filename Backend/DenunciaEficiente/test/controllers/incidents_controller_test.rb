...
class IncidentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create incident" do
    assert_difference('Incident.count') do
      post incidents_url, params: { incident: { created_at: @incident.created_at, description: @incident.description, incident_father_id: @incident.incident_father_id, name: @incident.name, updated_at: @incident.updated_at } }
    end
  ...
  test "should update incident" do
    patch incident_url(@incident), params: { incident: { created_at: @incident.created_at, description: @incident.description, incident_father_id: @incident.incident_father_id, name: @incident.name, updated_at: @incident.updated_at } }
