...
class ComplaintsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create complaint" do
    assert_difference('Complaint.count') do
      post complaints_url, params: { complaint: { date_incident: @complaint.date_incident, incident_id: @complaint.incident_id, location: @complaint.location, police_unit: @complaint.police_unit, user_id: @complaint.user_id } }
    end
  ...
  test "should update complaint" do
    patch complaint_url(@complaint), params: { complaint: { date_incident: @complaint.date_incident, incident_id: @complaint.incident_id, location: @complaint.location, police_unit: @complaint.police_unit, user_id: @complaint.user_id } }
